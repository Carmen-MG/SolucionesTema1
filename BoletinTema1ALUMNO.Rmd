...
Model1 <- lm(VitC ~ HeadWt, data = cabbages)
...
M_lineal1 <- lm(HeadWt~VitC, data = cabbages, subset = which(Cult == "c39"))
M_lineal2 <- lm(HeadWt~VitC, data = cabbages, subset = which(Cult == "c52"))

#Rectas del modelo lineal
abline(M_lineal1, col = "red")
abline(M_lineal2, lty = 5, col = "blue")
```
